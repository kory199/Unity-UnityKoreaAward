...
public partial class ParentSkillNode : Skills
{
    ...
    public ParentSkillNode(EnumTypes.PlayerSkiils skiils, int maxLv, int reqLb) : base(skillName, maxLv, reqLb)
    {
...
public partial class ChildrenSkillNode : Skills
{
    ...
    public ChildrenSkillNode(EnumTypes.PlayerSkiils skiils, int maxLv, int reqLb, ParentSkillNode parentNode) : base(skillName, maxLv, reqLb)
    {
        parent = parentNode;
    }
