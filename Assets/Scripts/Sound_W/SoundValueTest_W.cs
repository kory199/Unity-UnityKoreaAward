...
public class SoundValueTest_W : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        createBtn.onClick.AddListener(() => SoundMgr.Instance.SFXPlay(EnumTypes.SFXType.Button));
        loginBtn.onClick.AddListener(() => SoundMgr.Instance.SFXPlay(EnumTypes.SFXType.Button));
    }
